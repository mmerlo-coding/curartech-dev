const SingleFaq = (props: {
  ...
  return (
    <>
      <div
        className={`p-2 mb-12 flex lg:mb-[70px] ${isAlternate ? "bg-primary text-white" : "bg-white text-dark"}`}
      >
        <div
        ...
        <div className="w-full p-6">
          <h3
            className={`mb-6 text-xl font-semibold ${isAlternate ? "text-white" : "text-dark dark:text-white"} sm:text-2xl lg:text-xl xl:text-2xl`}
          >
            {question}
          </h3>
          <p
            className={`text-base ${isAlternate ? "text-white/90" : "text-body-color dark:text-dark-6"}`}
          >
            {answer}
          </p>
        </div>
